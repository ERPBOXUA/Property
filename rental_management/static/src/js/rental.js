...
class RentalDashboard extends Component {
    setup() {
        ...
        onWillStart(async () => {
            await loadJS('rental_management/static/src/js/lib/index.js');
            await loadJS('rental_management/static/src/js/lib/map.js');
            await loadJS('rental_management/static/src/js/lib/xy.js');
            await loadJS('rental_management/static/src/js/lib/worldLow.js');
            await loadJS('rental_management/static/src/js/lib/Animated.js');
            await loadJS('rental_management/static/src/js/lib/apexcharts.js');
